...
These are the values to which people in the Identity Identifier community should aspire:
...
Incidents that violate the Code of Conduct are extremely damaging to the Identity Identifier, and they will not be tolerated. The silver lining is that, in many cases, these incidents present a chance for the offenders, and the teams at large, to grow, learn, and become better. 
...
- Depending on the severity/details of the incident, removing a harasser from membership of relevant Identity Identifier organizations
